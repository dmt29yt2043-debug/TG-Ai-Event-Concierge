...
Q2_INTERESTS_OPTIONS = [
    ...
    {"id": "sports", "title": "Sports & Active"},
    {"id": "music", "title": "Music & Dance"},
    {"id": "nature", "title": "Nature & Animals"},
    {"id": "stem", "title": "STEM & Science"},
    {"id": "storytime", "title": "Storytime & Reading"},
    {"id": "social", "title": "Social & Playgroups"},
...
Q3_NEIGHBORHOODS_OPTIONS = [
    {"id": "manhattan_upper", "title": "Upper Manhattan", "description": "UWS, UES, Harlem"},
    ...
    {"id": "staten_island", "title": "Staten Island", "description": "All SI neighborhoods"},
...
ASK_DAY_BUTTONS = [
    {"id": "this_saturday", "title": "This Saturday"},
    {"id": "this_sunday", "title": "This Sunday"},
